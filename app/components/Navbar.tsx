    ...
    <div>
      <div className="fixed top-4 sm:top-6 left-0 w-full z-50 flex justify-center px-4 sm:px-6 lg:px-8">
        <header className="bg-[#18181b]/70 rounded-full h-20 py-2 px-4 sm:px-6 lg:px-8 flex items-center justify-between w-full max-w-7xl backdrop-blur-md relative border border-zinc-800/40">
         ...
         {/* Logo routing back home */}
<Link 
  href="/" 
  className="flex items-center justify-center hover:scale-105 transition-transform duration-200 shrink-0"
>
  {/* Standardized responsive wrapper using aspect ratio */}
  <div className="relative h-7 sm:h-8 md:h-9 lg:h-10 w-auto aspect-[13/3] flex items-center">
    <Image 
    ...
    />
          ...
          {/* Center: Desktop Navigation Links using <Link> */}
