  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-gray-900 min-h-screen">
      ...
      <div className="mb-[20px]">
        ...
        <h2 className=" text-3xl font-black block mb-2 bg-gradient-to-br from-[#004785] via-[#002142] to-[#000d1d] bg-clip-text text-transparent">
      ...
      <span className="text-xl font-black uppercase tracking-widest block mb-2 bg-gradient-to-br from-[#004785] via-[#002142] to-[#000d1d] bg-clip-text text-transparent">
          ...
          >
            <div className="flex flex-col">
              ...
              <div className="p-6 flex flex-col space-y-3">
                ...
                <p className="text-gray-500 text-[13px] leading-relaxed font-normal group-hover:text-zinc-300 transition-colors duration-300">
