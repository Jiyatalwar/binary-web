...
<span 
    className="absolute inset-0 rounded-[2rem] border-2 border-transparent pointer-events-none transition-all duration-500 ease-in-out group-hover:border-none"
    style={{ borderImage: 'linear-gradient(to right, #00D4FF, #090979) 1' }} 
  />              </div>
            );
          })}
        </div>
