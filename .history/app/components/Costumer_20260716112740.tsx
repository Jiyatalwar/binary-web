...
const Costumer = () => {
  ...
  return (
    <section className="bg-white py-16 sm:py-24 px-6 lg:px-8 w-full mt-[-50px]">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-zinc-200 pb-5 mb-10">
