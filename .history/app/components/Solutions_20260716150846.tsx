...
const Solutions = () => {
  ...
  return (
    <section 
      id="solutions" 
      className="pt-[-20px] relative w-full overflow-hidden bg-cover bg-center bg-no-repeat flex flex-col justify-center py-6 sm:py-10 lg:h-[780px] lg:max-h-[800px]" 
    ...
    >
      ...
      <div className="w-full max-w-6xl mx-auto px-4 flex flex-col justify-center h-full">
