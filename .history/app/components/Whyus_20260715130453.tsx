...
const Whyus = () => {
  return (
    <section className=" mt-[-100px] relative py-32 overflow-hidden bg-cover bg-center bg-no-repeat bg-fixed" style={{ backgroundImage: "url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ1e6OfXUpTpoZiNxD0sTwwjBif8z5vt9lZynYMR4j3yoXRA8nq2sE1nrc&s=10')" }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-16 border-t border-white pt-16 mt-[-100px]">
          ...
          <div className="flex flex-col items-start">
            ...
            <h3 className="text-xl font-bold tracking-widest uppercase mb-3 text-cyan-300">
              Business <span className="font-normal text-white">Strategy</span>
            </h3>
          ...
          <div className="flex flex-col items-start">
            ...
            <h3 className="text-xs font-bold tracking-widest uppercase mb-3">
              Projects <span className="font-normal text-white">Manager</span>
            </h3>
