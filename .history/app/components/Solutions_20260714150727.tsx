...
// Define 5 distinct cards for each tab category to perfectly match the Bento Grid layout
const categoryData = {
  infrastructure: {
    ...
    cards: [
      // 2 Large top cards (Row 1)
      {
        ...
        description: "Scale efficiently with modern enterprise hardware configurations, robust structures, and customized server physical-to-virtual integrations.",
        isLarge: true,
        graphicType: "grid"
      },
      {
        icon: <Network className="w-8 h-8 text-indigo-600" />,
        title: "Robust LAN/WAN Enterprise",
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="max-w-4xl mx-auto text-center flex flex-col items-center">
         <h2 className="text-5xl md:text-7xl font-extrabold tracking-tight mb-6 leading-[1.1] mt-[-100px] bg-gradient-to-b from-[#07065B] via-[#090979] to-[#020024] bg-clip-text text-transparent">
          ...
          <p className="bg-gradient-to-r from-[#3c3b3f] via-[#605c3c] to-[#605c3c] bg-clip-text text-transparent text-lg md:text-xl max-w-2xl font-large leading-relaxed">
       ...
       {/* --- INTERACTIVE CATEGORY LINKS (CENTERED) --- */}
        <div className="border-t border-zinc-200/80 pt-10 pb-4 mb-12">
          ...
          {/* Added "justify-center" to align the tab buttons in the middle */}
          <div className="flex flex-wrap gap-x-8 gap-y-4 items-center justify-center"> 
            ...
            <button 
               ...
               ? 'bg-gradient-to-r from-[#020024] to-[#090979] bg-clip-text text-transparent border-b-2 border-blue-600 pb-1' 
: 'bg-gradient-to-r from-[#020024] to-[#090979] bg-clip-text text-transparent hover:from-[#00D4FF] hover:to-[#090979] border-b-2 border-transparent hover:border-blue-400'               }`}>
            ...
            <button 
              ...
              className={`text-lg md:text-xl font-bold transition-all duration-300 focus:outline-none ${
                selectedCategory === 'cybersecurity' 
                  ? 'bg-gradient-to-r from-[#020024] to-[#090979] bg-clip-text text-transparent border-b-2 border-red-600 pb-1' 
                  : 'bg-gradient-to-r from-[#020024] to-[#090979] bg-clip-text text-transparent hover:from-[#00D4FF] hover:to-[#090979] border-b-2 border-transparent hover:border-red-400'
              }`}
            >
              Cyber Security
            </button>
              ...
              >
                ...
                <div className="relative z-10 flex justify-center items-center mt-6">
                  {card.isLarge ? (
                    ...
                    <div className={`relative flex items-center justify-center w-16 h-16 rounded-2xl bg-slate-50 border border-slate-100 shadow-[0_8px_20px_rgba(0,0,0,0.03)] transition-transform duration-300
                      ${card.graphicType === "tilt-left" ? "rotate-12 group-hover:rotate-0" : ""}
                      ${card.graphicType === "tilt-right" ? "-rotate-12 group-hover:rotate-0" : ""}
                      ${card.graphicType === "scale" ? "group-hover:scale-115" : ""}
                    `}>
                      {card.icon}
                    </div>
                  )}
