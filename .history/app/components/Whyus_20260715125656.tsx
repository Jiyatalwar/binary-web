...
const Whyus = () => {
  return (
    <section className="text-zinc-900 pt-32 pb-20 px-6 md:px-10 mt-[-90px] min-h-screen flex flex-col justify-center">
      ...
      <div className="w-full max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20 items-start mb-24">
          <div>
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-serif text-zinc-950 leading-tight tracking-tight">
              Why Customers  Binary Global <br />Choose <br />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-16 border-t border-zinc-300/60 pt-16">
          {/* Feature 1 */}
