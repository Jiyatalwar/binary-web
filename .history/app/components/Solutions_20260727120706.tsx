...
<div 
  className="my-[30px] sm:my-[40px] -mx-4 px-4 overflow-x-auto snap-x snap-mandatory pb-3
    ...
    scrollbar-thin"
>
  <div className="flex items-center justify-start gap-2 sm:gap-3 w-max border-b border-gray-200/85 pb-3">
