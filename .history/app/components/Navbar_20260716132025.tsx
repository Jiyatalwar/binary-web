...
export default function Navbar() {
  ...
  return (
    <div>
      <div className="fixed top-4 sm:top-6 left-0 w-full z-50 flex justify-center px-3 sm:px-4">
        {/* --- FLOATING CAPSULE CONTAINER --- */}
        <header className="bg-[#18181b] border border-zinc-800/50 rounded-full h-16 sm:h-20 py-2 px-3 sm:px-6 flex items-center justify-between w-full max-w-6xl shadow-[0_20px_50px_rgba(0,0,0,0.5)] backdrop-blur-md relative">
