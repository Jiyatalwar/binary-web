    ...
    Your browser does not support the video tag.
        ...
        <div className="w-full max-w-6xl mx-auto px-4 lg:px-0">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20 items-start mb-24">
            ...
            <div className="group/hero cursor-default select-none animate-present-slow mt-[-100px]" style={{ animationDelay: '0s' }}>
            ...
            <div className="flex flex-col items-start justify-center h-full pt-2 lg:pt-8 group/desc animate-present-slow mt-[-100px]" style={{ animationDelay: '0.6s' }}>
