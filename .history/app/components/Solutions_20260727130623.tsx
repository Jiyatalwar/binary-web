    ...
    {solutionsNavbar.map((solutionName) => {
      ...
      return (
        <Link
          ...
          className={`px-4 sm:px-6 py-3 sm:py-2.5 rounded-full text-[13ssspx] sm:text-xs md:text-sm font-medium shadow-sm border transition-all duration-300 hover:scale-[1.03] origin-left cursor-pointer whitespace-nowrap text-center snap-ml-4 ${
            isActive
