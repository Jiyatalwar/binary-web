...
const Whyus = () => {
  ...
  return (
    <>
      ...
      */}
      <section className="relative min-h-screen lg:h-[700px] w-full overflow-hidden bg-[#020617] flex flex-col justify-center py-12 lg:py-0 mt-[-100px]">
        ...
        <div className="relative z-10 w-full max-w-6xl mx-auto px-6 lg:px-0 flex flex-col justify-between h-full gap-8 lg:gap-0 mb-20">
          ...
          */}
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 border-t border-white/20 pt-6 mb-20">
