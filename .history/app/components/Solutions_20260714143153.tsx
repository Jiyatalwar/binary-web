    ...
    <section id="solutions" className="relative py-32 bg-[#f4f7fa] text-zinc-900 overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="max-w-4xl mx-auto text-center flex flex-col items-center">
         <h2 className="text-5xl md:text-7xl font-extrabold tracking-tight mb-6 leading-[1.1] mt-[-100px] bg-gradient-to-b from-[07065B] via-[#06429E] to-[#02A8E2] bg-clip-text text-transparent">
             Our Solutions
         </h2>
