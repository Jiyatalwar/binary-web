...
const Solutions = () => {
  ...
  return (
    <section id="solutions" className="relative min-h-[700px] md:min-h-[800px] py-20 md:py-32 overflow-hidden bg-cover bg-center bg-no-repeat bg-fixed flex items-center" style={{ backgroundImage: "url('')" }}>
