...
import { 
  Server, Shield, Cloud, Cpu, Database, 
  Key, Terminal, Eye, Lock, Share2, Layers,
   HardDriveDownload, BarChart3, RefreshCw, Blocks
} from 'lucide-react';
...
const Solutions = () => {
  ...
  return (
    <section id="solutions" className="relative py-20 md:py-32 overflow-hidden bg-cover bg-center bg-no-repeat bg-fixed">
      ...
      <div className="max-w-6xl mx-auto px-6 mt-[-100px]">
        ...
        <div className="max-w-4xl mx-auto text-center flex flex-col items-center">
          <h2 className="mb-2 text-4xl md:text-6xl font-extrabold tracking-tight leading-[1.1] bg-gradient-to-tr from-[#314f78] via-[#162234] to-[#182952] bg-clip-text text-transparent">
              Our Solutions
          </h2>
        ...
        <div className="border-t border-zinc-200/80 pb-4 mb-10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-6 gap-6 transition-all duration-500">
          {categoryData[selectedCategory].cards.map((card, index) => {
            ...
            return (
              <div 
               key={index}
    className={`group flex flex-col justify-between items-center text-center border border-[#2c4260]/10 rounded-[2rem] p-5 relative overflow-hidden hover:-translate-y-1 transition-all duration-300 bg-cover bg-top bg-no-repeat ${gridClasses}`}
    style={{
      // The linear gradient layers on top of the image, fading it out to transparent at the bottom
      backgroundImage: `linear-gradient(to bottom, rgba(44, 66, 96, 0.12) 0%, rgba(22, 34, 52, 0.04) 50%, transparent 100%), url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS2Wj6xP-qTwju5hHAGu8zf15nJkqUdesFvtfWUZSoCmA&s=10')`
    }}
  >
