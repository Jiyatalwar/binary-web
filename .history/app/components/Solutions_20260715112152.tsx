...
const categoryData = {
 ...
 icon: (
  <img 
    ...
    alt="icon" // Empty string tells screen readers to skip reading the raw URL/element name
...
const Solutions = () => {
  ...
  return (
    <section id="solutions" className="relative py-32 overflow-hidden bg-cover bg-center bg-no-repeat bg-fixed" style={{ backgroundImage: "url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTX9LzbUXDma5HpXmj6dZe5lYOSKTBwGfrP7JO2IZy1xGDQLYyZFMNHUOSs&s=10')" }}>
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="max-w-4xl mx-auto text-center flex flex-col items-center">
          <h2 className="text-5xl md:text-7xl font-extrabold tracking-tight mb-2 leading-[1.1] mt-[-130px] bg-gradient-to-b from-[#07065B] via-[#090979] to-[#020024] bg-clip-text text-transparent">
              Our Solutions
          </h2>
          <p className="text-gray-900/60  text-sm md:text-xl max-w-2xl font-medium leading-relaxed mb-3">
        ...
        <div className="h-4 mb-[-20px]">
        </div>

        {/* --- INTERACTIVE CATEGORY LINKS (CENTERED) --- */}
        <div className="border-t border-zinc-200/80 pt-10 pb-4 ">
          <div className="flex flex-wrap gap-x-8 gap-y-4 items-center justify-center mt-[-30px]"> 
        ...
        <div className="grid grid-cols-2 md:grid-cols-6 gap-6 transition-all duration-500 ">
          {categoryData[selectedCategory].cards.map((card, index) => {
            ...
            return (
              <div 
                key={index}
className={`group flex flex-col justify-between items-center text-center bg-gradient-to-b from-[#E6E6F1] to-transparent  border-[#04043C]/20 rounded-[2rem] p-8 relative overflow-hidden hover:shadow-[0_20px_40px_rgba(0,0,0,0.04)] hover:-translate-y-1 transition-all duration-300 ${gridClasses}`}              >
                ...
                <div className="relative z-10 flex flex-col items-center">
                  <h3 className="font-black text-xl bg-gradient-to-b from-[#07065B] via-[#090979] to-[#020024] bg-clip-text text-transparent group-hover:text-black transition-colors">
                    {card.title}
                  </h3>
                ...
                {/* <div className="relative z-10 flex justify-center items-center">
                  {card.isLarge ? (
                    ...
                    <div className="relative flex items-center justify-center w-25 h-25 rounded-full bg-slate-50 border border-slate-100 shadow-[0_8px_20px_rgba(0,0,0,0.04)] group-hover:scale-105 transition-transform duration-300 mt-[20px]">
                      {card.icon}
                    ...
                    <div className={`relative flex items-center justify-center w-30 h-20 mt-3 rounded-2xl bg-slate-50 border border-slate-100 shadow-[0_8px_20px_rgba(0,0,0,0.03)] transition-all duration-300 
