...
const Solutions = () => {
  ...
  // Motion Configuration Variants for the Grid Container
  const containerVariants = {
    hidden: { opacity: 0 },
    show: {
      opacity: 1,
      transition: {
        staggerChildren: 0.08, // Subtle, clean staging ripple effect between items
      }
    }
  };

  // Motion Configuration Variants for Individual Cards
  const cardVariants = {
  ...
  return (
    <section id="solutions" className="relative py-28 overflow-hidden bg-cover bg-center bg-no-repeat bg-fixed">
      ...
      <div className="max-w-6xl mx-auto px-6">
            ...
            {(['SmartInfrastructure', 'cloud', 'dataManagement', 'cybersecurity'] as CategoryKey[]).map((cat) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Shared layout active underline bar animation */}
                  {isActive && (
                    <motion.div 
        ...
        <AnimatePresence mode="wait">
          <motion.div 
            key={selectedCategory} // Key re-triggers layout animation sequence when tab updates
            ...
            {categoryData[selectedCategory].cards.map((card, index) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Subtle border accent overlay on hover */}
