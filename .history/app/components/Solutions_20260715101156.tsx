...
const Solutions = () => {
  ...
  return (
    <section id="solutions" className="relative py-32 overflow-hidden bg-cover bg-center bg-no-repeat bg-fixed" style={{ backgroundImage: "url('')" }}>
  ...
  {categoryData[selectedCategory].cards.map((card, index) => {
    // 1. Force the 3rd card (index 2) to be large, or respect the card.isLarge property
    const isLargeCard = card.isLarge || index === 2;

    // 2. Large cards span 3 columns (half-width on desktop), normal span 2 (one-third width)
    const gridClasses = isLargeCard  
      ? 'col-span-2 md:col-span-3 min-h-[300px]' 
      : 'col-span-2 md:col-span-2 min-h-[300px]';
    ...
    return (
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center">
          ...
          <p className="text-gray-900 text-sm md:text-base leading-relaxed font-normal mt-2 max-w-sm">
            {card.description}
          </p>
        </div>
        ...
        <div className="relative z-10 flex justify-center items-center">
          {isLargeCard ? (
            ...
            <div className="relative flex items-center justify-center w-24 h-24 rounded-full bg-slate-50 border border-slate-100 shadow-[0_8px_20px_rgba(0,0,0,0.04)] group-hover:scale-105 transition-transform duration-300 mt-[20px]">
              {card.icon}
            ...
            <div className={`relative flex items-center justify-center w-28 h-20 mt-3 rounded-2xl bg-slate-50 border border-slate-100 shadow-[0_8px_20px_rgba(0,0,0,0.03)] transition-all duration-300 
