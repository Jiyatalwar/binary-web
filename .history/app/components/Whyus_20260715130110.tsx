      ...
      <div className="w-full max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20 items-start mb-24">
          ...
          <div className="flex flex-col items-start justify-center h-full pt-2 lg:pt-8">
            ...
            <button className="border border-white text-zinc-950 hover:bg-zinc-950 hover:text-white transition-all duration-300 px-8 py-2.5 text-xs tracking-widest uppercase font-semibold">
              Button
            </button>
          </div>
        </div>
