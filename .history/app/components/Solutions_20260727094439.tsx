  ...
  const solutionsDataRepository: Record<string, SolutionData> = {
    'Smart Infrastructure': {
      ...
      components: [
        {
          id: 1,
          title: 'Upgrade to enterprise-grade Wi-Fi 6E and Wi-Fi 7 for secure, scalable, high-performance wireless connectivity built for AI-ready enterprises. k',
          description: 'Enterprise Wireless Solutions | Wi-Fi 6E & Wi-Fi 7 Networks ',
