          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-5 border-t border-white/10 pt-6 lg:pt-8 w-full">
            {features.map((item, index) => (
              ...
              >
                ...
                <h3 className="text-xl sm:text-base font-bold tracking-wider uppercase mb-2 text-cyan-400 group-hover:text-cyan-600 leading-tight transition-colors duration-300">
                  {item.titleLine1} 
