...
const categoryData = {
 ...
 icon: (
  <img 
    src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ2-6nGP4pFVQWFQROQjpPw0jhBodKQMat71MV7FyzUSQ&s=1024"
    alt="icon" // Empty string tells screen readers to skip reading the raw URL/element name
    className="w-13 h-15 object-contain transition-transform duration-300 group-hover:scale-110" 
  />
),
