    ...
    <section id="solutions" className="relative py-32 bg-[#f4f7fa] text-zinc-900 overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="max-w-4xl mx-auto text-center flex flex-col items-center">
          <h2 className="text-5xl md:text-7xl font-extrabold tracking-tight  mb-6 leading-[1.1] mt-[-100px]">
            Our Solutions
          </h2>
       ...
       {/* --- INTERACTIVE CATEGORY LINKS (CENTERED) --- */}
        <div className="border-t border-zinc-200/80 pt-10 pb-4 mb-12">
          ...
          {/* Active Tagline - Added "text-center" to center the description line */}
          <p className="text-zinc-500 text-sm mt-4 animate-fade-in font-medium italic text-center">
