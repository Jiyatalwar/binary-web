        ...
        <div className="bg-gradient-to-tr from-[#2c4260] via-[#162234] to-[#0a0e17] rounded-2xl overflow-hidden shadow-xl mb-24 transition-all duration-300 hover:shadow-2xl">
          <div className="grid grid-cols-1 lg:grid-cols-12">
            ...
            <div className="p-8 sm:p-12 lg:p-16 lg:col-span-7 flex flex-col justify-between text-white space-y-12">
              ...
              <div>
                <button className="inline-flex items-center gap-1.5 text-sm font-medium text-zinc-300 hover:text-white group transition-colors transition-transform duration-300 hover:scale-[1.03] origin-left cursor-pointer hover:bg-white rounded-full hover:text-gray-900">
                  Read more 
