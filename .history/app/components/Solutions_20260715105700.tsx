...
const Solutions = () => {
  ...
  return (
    <section id="solutions" className="relative py-32 overflow-hidden bg-cover bg-center bg-no-repeat bg-fixed" style={{ backgroundImage: "url('https://img.magnific.com/premium-photo/minimal-light-blue-gradient-background-foe-ad-design_558873-55746.jpg?semt=ais_hybrid&w=740&q=80')" }}>
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="max-w-4xl mx-auto text-center flex flex-col items-center">
          ...
          <p className="text-black  text-sm md:text-xl max-w-2xl font-medium leading-relaxed mb-3">
