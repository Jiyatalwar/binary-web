...
>
  ...
  <video
    ...
    muted
    playsInline
    className="absolute inset-0 w-full h-230 object-cover opacity-25 mix-blend-screen pointer-events-none z-0"
  >
    <source 
      src="public/vedioes/hero-background2.mp4" 
      type="video/mp4" 
    />
    Your browser does not support the video tag.
  </video>
        <div className="w-full max-w-6xl mx-auto px-4 lg:px-0 mb-[-50px]">
