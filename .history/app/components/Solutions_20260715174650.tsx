...
const Solutions = () => {
  ...
  return (
    <section 
      id="solutions" 
      className="relative min-h-[600px] w-full overflow-hidden bg-cover bg-center bg-no-repeat bg-fixed flex flex-col items-center justify-center py-16 md:py-24" 
