...
const Solutions = () => {
  ...
  return (
    <section 
      id="solutions" 
      className="pt-[-70px] relative w-full overflow-hidden bg-cover bg-center bg-no-repeat flex flex-col justify-center py-6 sm:py-10 lg:h-[780px] lg:max-h-[800px]" 
