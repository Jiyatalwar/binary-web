...
const Solutions = () => {
  ...
  return (
    <section id="solutions" className="relative py-32  text-zinc-900 overflow-hidden bg-cover bg-center bg-no-repeat bg-fixed" style={{ backgroundImage: "url('background-img/19366.jpg')" }}>
