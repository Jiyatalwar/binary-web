...
const Solutions = () => {
  ...
  return (
    <section id="solutions" className="relative py-20 md:py-32 overflow-hidden bg-cover bg-center bg-no-repeat bg-fixed" style={{ backgroundImage: "url('')" }}>
      
      {/* Subtle background glow effect (soft blues and indigos) */}
      <div className="absolute top-0 left-1/4 w-[500px] h-[3 00px] bg-blue-100/40 rounded-full blur-[120px] -z-10" />
      <div className="absolute bottom-10 right-1/4 w-[400px] h-[400px] bg-indigo-100/40 rounded-full blur-[100px] -z-10" />
    
      <div className="max-w-6xl mx-auto px-6 mt-[-140px]">
        
        {/* --- HERO / HEADING --- */}
        <div className="max-w-4xl mx-auto text-center flex flex-col items-center">
          <h2 className="text-4xl mb-2  md:text-6xl font-extrabold tracking-tight leading-[1.1] bg-gradient-to-b from-[#07065B] via-[#090979] to-[#020024] bg-clip-text text-transparent">
              Our Solutions
          </h2>
         <p className="text-gray-600 tracking-normal text-sm md:text-xl max-w-2xl font-normal leading-tight mb-2">
        ...
        <div className="border-t border-zinc-200/80 pb-4 pt-2 mb-8">
        ...
        {/* --- BENTO GRID CARDS --- */}
        <div className="grid grid-cols-2 md:grid-cols-6 gap-6 transition-all duration-500 mb-2">
          {categoryData[selectedCategory].cards.map((card, index) => {
            const gridClasses = card.isLarge  
              ? 'col-span-2 md:col-span-3 min-h-[200px]' 
              : 'col-span-2 md:col-span-2 min-h-[200px]';

            return (
              <div 
                key={index}
                className={`group flex flex-col justify-between items-center text-center bg-gradient-to-b from-[#E6E6F1] to-transparent border border-[#04043C]/20 rounded-[2rem] p-8 relative overflow-hidden hover:shadow-[0_20px_40px_rgba(0,0,0,0.04)] hover:-translate-y-1 transition-all duration-300 ${gridClasses}`}
              >
                ...
                <div className="relative z-10 flex justify-center items-center mt-auto">
                  {card.isLarge ? (
                    ...
                    <div className="relative flex items-center justify-center w-25 h-25 rounded-full bg-slate-50 border border-slate-100 shadow-[0_8px_20px_rgba(0,0,0,0.04)] group-hover:scale-105 transition-transform duration-300">
                      {card.icon}
