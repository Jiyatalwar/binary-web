...
const Whyus = () => {
  ...
  return (
    <section className=" mt-[-80px] relative py-25 overflow-hidden bg-cover bg-center bg-no-repeat bg-fixed" style={{ backgroundImage: "url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS9BTRRVfRpPI6mxxG4ZnwT3tw39MJNcTU1XvtZw43GpXOno47l2kyFx_w&s=10')" }}>
