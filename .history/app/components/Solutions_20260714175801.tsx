...
const Solutions = () => {
  ...
  <section id="solutions" className="relative py-32 bg-[#f4f7fa] text-zinc-900 overflow-hidden">
      ...
      {/* BACKGROUND IMAGE LAYER 
        - Replace '/images/tech-pattern.png' with your preferred background file path.
        - Set opacity-10 to keep it subtle so text remains incredibly easy to read.
      */}
      <div 
        className="absolute inset-0 bg-cover bg-center bg-no-repeat opacity-[0.08] mix-blend-overlay pointer-events-none -z-20" 
        style={{ backgroundImage: "url('/images/tech-pattern.png')" }} 
      />
