...
const Solutions = () => {
  ...
  return (
    <section id="solutions" className="relative py-32 overflow-hidden bg-cover bg-center bg-no-repeat bg-fixed" style={{ backgroundImage: "url('https://img.magnific.com/free-photo/artistic-blurry-colorful-wallpaper-background_58702-8211.jpg?semt=ais_hybrid&w=740&q=80')" }}>
