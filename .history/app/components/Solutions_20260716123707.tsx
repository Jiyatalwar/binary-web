    ...
    <section id="solutions" className="relative py-20 md:py-32 overflow-hidden bg-cover bg-center bg-no-repeat bg-fixed" style={{ backgroundImage: "url('')" }}>
      ...
      <div className="max-w-6xl mx-auto px-6 mt-[-100px]">
        ...
        <div className="max-w-4xl mx-auto text-center flex flex-col items-center">
          <h2 className="mb-2 text-4xl md:text-6xl font-extrabold tracking-tight leading-[1.1] bg-gradient-to-tr from-[#2c4260] via-[#162234] to-[#0a0e17] bg-clip-text text-transparent">
              Our Solutions
          </h2>
        ...
        <div className="grid grid-cols-2 md:grid-cols-6 gap-6 transition-all duration-500">
          {categoryData[selectedCategory].cards.map((card, index) => {
            ...
            return (
              <div 
                key={index}
                className={`group flex flex-col justify-between items-center text-center bg-gradient-to-b from-transprent via-[#162234]/10 to-[#082567]/20  rounded-[2rem] p-5 relative overflow-hidden hover:-translate-y-1 transition-all duration-300 ${gridClasses}`}
              >
