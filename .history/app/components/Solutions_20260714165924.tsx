              ...
              >
                ...
                <div className="relative z-10 flex justify-center items-center">
                  {card.isLarge ? (
                    ...
                    <div className="relative flex items-center justify-center w-20 h-20 rounded-full border border-slate-100/50 shadow-[0_8px_20px_rgba(0,0,0,0.02)] group-hover:scale-105 transition-transform duration-300 mt-[-150px]">
                      {card.icon}
