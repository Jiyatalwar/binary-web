    ...
    <section id="solutions" className="relative py-20 md:py-32 overflow-hidden bg-cover bg-center bg-no-repeat bg-fixed" style={{ backgroundImage: "url('')" }}>
      ...
      <div className="max-w-6xl mx-auto px-6 mt-[-100px]">
        ...
        <div className="max-w-4xl mx-auto text-center flex flex-col items-center">
         ...
         <p className=" mb-4 text-gray-800 tracking-normal text-sm md:text-xl max-w-2xl font-normal leading-tight mb-2">
        ...
        <div className="border-t border-zinc-200/80 pb-4 mb-10">
          <div className="flex flex-wrap gap-x-8 gap-y-4 items-center justify-center mb-20"> 
