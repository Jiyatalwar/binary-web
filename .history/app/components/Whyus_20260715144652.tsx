...
const Whyus = () => {
  ...
  // Presentation Animation Configurations (Scroll Entrances)
  ...
  return (
    ...
    >
      <div className="w-full max-w-6xl mx-auto px-4 lg:px-0">
        ...
        {/* ==========================================
            TOP HERO SECTION WITH SCROLL & HOVER MOTIONS
            ========================================== */}
        <motion.div 
        ...
        >
          {/* Left Block: Subtitle and Headline */}
          ...
          {/* Right Block: Content Context paragraph & CTA */}
