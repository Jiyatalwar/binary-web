...
>
  ...
  <video
    ...
    muted
    playsInline
    className="absolute inset-0 w-full h-full object-cover opacity-10 mix-blend-screen pointer-events-none z-0"
  >
    <source src="public/vedioes/vecteezy_business-button-24-hours-service-online-netcom-web-icon_1807827.mp4" type="video/mp4" />
        ...
        <div className="w-full max-w-6xl mx-auto px-4 lg:px-0">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20 items-start mb-24">
            ...
            <div className="group/hero cursor-default select-none animate-present-slow" style={{ animationDelay: '0s' }}>
              <span className="text-xs font-bold tracking-widest text-white block mb-4 transition-transform duration-500 ease-out group-hover/hero:translate-x-1">
                What We Do
              </span>
            ...
            <div className="flex flex-col items-start justify-center h-full pt-2 lg:pt-8 group/desc animate-present-slow" style={{ animationDelay: '0.6s' }}>
