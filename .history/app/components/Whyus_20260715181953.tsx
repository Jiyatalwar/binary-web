...
const Whyus = () => {
  ...
  return (
    <>
      ...
      */}
      <section className="relative h-[650px] w-full overflow-hidden bg-[#020617] flex flex-col justify-center">
        ...
        */}
        ...
        <div className="relative z-10 w-full max-w-6xl mx-auto px-4 lg:px-0 flex flex-col justify-between py-6 h-full">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 border-t border-white/20 pt-6 mb-10">
