...
const categoryData = {
 ...
 icon: (
  <img 
    src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSl1Azl4wzckohIUIzeF60GNCUjiA3ZPZIsTzNlRyy-0w&s=10"
    alt="icon" // Empty string tells screen readers to skip reading the raw URL/element name
    className="w-18 h-13 object-contain transition-transform duration-300 group-hover:scale-110" 
  />
...
const Solutions = () => {
  ...
  <section id="solutions" className="relative py-32 text-zinc-900 overflow-hidden">
      <div 
        className="absolute inset-0 bg-cover bg-center bg-no-repeat opacity-[0.08] mix-blend-overlay pointer-events-none -z-20" 
        style={{ backgroundImage: "url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcROvrsO3tQSyMpmeV8zByoRk2o2heG8-vpYmBpLHgMqCquVaelNxszsiH8M&s=10')" }} 
      />
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="max-w-4xl mx-auto text-center flex flex-col items-center">
          ...
          <p className="text-gray-900  text-sm md:text-xl max-w-2xl font-light leading-relaxed mb-3">
...
className={`group flex flex-col justify-between items-center text-center bg-gradient-to-b from-[#E6E6F1] to-transparent  border-[#04043C]/20 rounded-[2rem] p-8 relative overflow-hidden hover:shadow-[0_20px_40px_rgba(0,0,0,0.04)] hover:-translate-y-1 transition-all duration-300 ${gridClasses}`}              >
                ...
                <div className="relative z-10 flex justify-center items-center">
                  {card.isLarge ? (
                    ...
                    <div className="relative flex items-center justify-center w-25 h-25 rounded-full bg-slate-50 border border-slate-100 shadow-[0_8px_20px_rgba(0,0,0,0.04)] group-hover:scale-105 transition-transform duration-300 mt-[-150px]">
                      {card.icon}
                    ...
                    <div className={`relative flex items-center justify-center w-20 h-20 rounded-2xl bg-slate-100 border border-slate-100 shadow-[0_8px_20px_rgba(0,0,0,0.03)] transition-all duration-300 mt-[-100px]
