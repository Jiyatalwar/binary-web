        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-16 border-t border-white pt-16 mt-[-80px]">
          ...
          <div className="flex flex-col items-start">
            ...
            <h3 className="text-xl font-bold tracking-widest uppercase mb-3 text-cyan-300">
              Converged  <span className="font-normal text-white">Solutions</span>
            </h3>
          ...
          <div className="flex flex-col items-start">
            ...
            <h3 className="text-xl font-bold tracking-widest uppercase mb-3 text-cyan-300">
             Industry <span className="font-normal text-white">Vertical Focused</span>
            </h3>
            <p className="text-white text-xs md:text-sm leading-relaxed">
              Sample text. Lorem ipsum dolor sit amet, consectetur adipiscing elit nullam nunc justo sagittis suscipit ultrices.
            </p>
          ...
          <div className="flex flex-col items-start">
            ...
            <h3 className="text-xl font-bold tracking-widest uppercase mb-3 text-cyan-300">
              Exceptional<span className="font-normal text-white">Customer Service</span>
            </h3>
            <p className="text-white text-xs md:text-sm leading-relaxed">
              Sample text. Lorem ipsum dolor sit amet, consectetur adipiscing elit nullam nunc justo sagittis suscipit ultrices.
            </p>
          ...
          <div className="flex flex-col items-start">
            ...
            <h3 className="text-xl font-bold tracking-widest uppercase mb-3 text-cyan-300">
              Strong <span className="font-normal text-white">Partnerships</span>
            </h3>
            <p className="text-white text-xs md:text-sm leading-relaxed">
              Sample text. Lorem ipsum dolor sit amet, consectetur adipiscing elit nullam nunc justo sagittis suscipit ultrices.
            </p>
          ...
          <div className="flex flex-col items-start">
            ...
            <h3 className="text-xl font-bold tracking-widest uppercase mb-3 text-cyan-300">
              Cloud <span className="font-normal text-white"> Confidence</span>
            </h3>
            <p className="text-white text-xs md:text-sm leading-relaxed">
              Sample text. Lorem ipsum dolor sit amet, consectetur adipiscing elit nullam nunc justo sagittis suscipit ultrices.
            </p>
          ...
          <div className="flex flex-col items-start">
            ...
            <h3 className="text-xl font-bold tracking-widest uppercase mb-3 text-cyan-300">
              Internet <span className="font-normal text-white">Technology</span>
            </h3>
            <p className="text-white text-xs md:text-sm leading-relaxed">
              Sample text. Lorem ipsum dolor sit amet, consectetur adipiscing elit nullam nunc justo sagittis suscipit ultrices.
            </p>
