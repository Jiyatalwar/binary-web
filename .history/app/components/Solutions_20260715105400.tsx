...
const Solutions = () => {
  ...
  return (
    <section id="solutions" className="relative py-32 overflow-hidden bg-cover bg-center bg-no-repeat bg-fixed" style={{ backgroundImage: "url('https://img.magnific.com/free-vector/soft-whiten-blue-abstract-gradient-background_69286-554.jpg')" }}>
