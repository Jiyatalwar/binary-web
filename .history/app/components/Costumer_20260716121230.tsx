  ...
  return (
    <section className="bg-white py-16 sm:py-24 px-6 lg:px-8 w-full mt-[-60px]">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-gradient-to-b from-[#07065B] via-[#090979] to-[#020024] rounded-2xl overflow-hidden shadow-xl mb-24 transition-all duration-300 hover:shadow-2xl">
