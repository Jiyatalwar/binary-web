        ...
        <div className="border-t border-zinc-200/80 pt-10 pb-4 mb-12">
          ...
          <div className="flex flex-wrap gap-x-8 gap-y-4 items-center justify-center"> 
            ...
            <button 
              ...
              : 'bg-gradient-to-r from-[#020024] to-[#090979] hover:bg-gradient-to-r hover:from-[#00D4FF] hover:to-[#090979] hover:bg-clip-text hover:text-transparent border-b-2 border-transparent hover:border-blue-400'
               }`}>
