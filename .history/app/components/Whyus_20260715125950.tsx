...
const Whyus = () => {
  return (
    <section className="relative py-32 overflow-hidden bg-cover bg-center bg-no-repeat bg-fixed" style={{ backgroundImage: "url('https://i.pinimg.com/236x/fd/09/94/fd099408f7d2823899b828cda6a13dc9.jpg')" }}>
      ...
      <div className="w-full max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20 items-start mb-24">
          <div>
            <span className="text-xs font-bold tracking-widest uppercase text-zinc-500 block mb-4">
              What We Do
            </span>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-serif text-zinc-950 leading-tight tracking-tight">
          ...
          <div className="flex flex-col items-start justify-center h-full pt-2 lg:pt-8">
            ...
            <button className="border border-zinc-950 text-zinc-950 hover:bg-zinc-950 hover:text-white transition-all duration-300 px-8 py-2.5 text-xs tracking-widest uppercase font-semibold">
              Button
            </button>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-16 border-t border-zinc-300/60 pt-16 mt-[-100px]">
          {/* Feature 1 */}
