...
const Solutions = () => {
  ...
  className={`text-lg md:text-xl font-bold transition-all duration-300 focus:outline-none pb-1 ${
    selectedCategory === 'infrastructure' 
      ...
      : 'hover:bg-gradient-to-r hover:from-[#00D4FF] hover:to-[#090979] hover:bg-clip-text hover:text-transparent border-b-2 border-transparent hover:border-blue-400'
  }`}
>
  Infrastructure
</button>
