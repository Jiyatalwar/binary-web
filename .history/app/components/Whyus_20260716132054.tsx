...
const Whyus = () => {
  ...
  return (
    <>
      ...
      */}
      <section className="relative min-h-[85vh] sm:min-h-[90vh] lg:min-h-[700px] w-full overflow-hidden bg-[#020617] flex flex-col justify-center py-16 sm:py-20 lg:py-0 mt-0 sm:mt-[-30px] lg:mt-[-70px]">
        ...
        <div className="relative z-10 w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-0 flex flex-col justify-between h-full gap-8 lg:gap-0 mb-8 sm:mb-12 lg:mb-20">
          
          {/* Top Section: Header and Intro Text */}
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-20 items-start mt-16 sm:mt-20 lg:mt-30">
            ...
            <div className="flex flex-col items-start justify-center h-full group/desc animate-present-slow" style={{ animationDelay: '0.6s' }}>
              <p className="text-zinc-300 lg:text-white text-sm sm:text-base lg:text-[18px] leading-relaxed max-w-xl origin-left transition-transform duration-700 ease-out lg:group-hover/desc:scale-[1.02]">
          ...
          */}
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 border-t border-white/20 pt-6 mb-8 sm:mb-12 lg:mb-20">
            {features.map((item, index) => (
              ...
              >
                ...
                {/* Feature Subtext */}
                <p className="text-white group-hover:text-zinc-600 text-[11px] sm:text-xs leading-normal max-w-sm transition-all duration-300 lg:group-hover:scale-[1.02] origin-left">
                  {item.desc}
                </p>
              </div>
            ))}
