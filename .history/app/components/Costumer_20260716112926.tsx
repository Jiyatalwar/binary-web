  ...
  const gridStories = [
    {
      ...
      desc: "Shopz solved the mass onboarding complications with structured workflows and dedicated support modules.",
    },
    {
      id: 2,
      brand: "PayUp",
      ...
      desc: "PayUp switches to HRLink to facilitate change management and rapid international expansion strategies.",
    },
    {
      id: 3,
      brand: "Planner",
      ...
      desc: "Planner scales by 30% in one year — staying completely lean and efficient with automated systems.",
    }
  ];

  return (
    <section className="bg-white py-16 sm:py-24 px-6 lg:px-8 w-full mt-[-60px]">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="max-w-3xl mb-12 sm:mb-16">
          ...
          <h2 className="text-4xl sm:text-5xl md:text-6xl font-black text-zinc-950 tracking-tight leading-tight mb-6">
            Trusted by thousands of fast-growing companies.
          </h2>
          <p className="text-zinc-600 text-base sm:text-lg max-w-2xl leading-relaxed mb-8">
        ...
        <div className="bg-zinc-950 rounded-2xl overflow-hidden shadow-xl mb-24 transition-all duration-300 hover:shadow-2xl">
          <div className="grid grid-cols-1 lg:grid-cols-12">
            ...
            <div className="p-8 sm:p-12 lg:p-16 lg:col-span-7 flex flex-col justify-between text-white space-y-12">
              <div>
                ...
                <h3 className="text-2xl sm:text-3xl lg:text-4xl font-semibold tracking-tight leading-snug text-zinc-100">
                  From manual to digital - Acme.inc masters employee management with HRLink
                </h3>
              </div>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-zinc-200 pb-5 mb-10 mt-[-100px]">
