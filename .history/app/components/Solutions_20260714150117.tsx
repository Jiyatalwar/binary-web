...
const Solutions = () => {
  ...
  className={`text-lg md:text-xl font-bold transition-all duration-300 focus:outline-none pb-1 ${
    selectedCategory === 'infrastructure' 
      // Active State: Deep Blue gradient with an active bottom border
      ? 'bg-gradient-to-r from-[#020024] to-[#090979] bg-clip-text text-transparent border-b-2 border-blue-600' 
      // Inactive State: Subtle gray text, but hovers into a bright cyan-to-blue gradient shift
      : 'text-zinc-400 hover:bg-gradient-to-r hover:from-[#00D4FF] hover:to-[#090979] hover:bg-clip-text hover:text-transparent border-b-2 border-transparent hover:border-blue-400'
  }`}
>
  Infrastructure
</button>
