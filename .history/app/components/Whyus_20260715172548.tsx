...
const Whyus = () => {
  ...
  return (
    <>
      ...
      {/* Main Section: Standard padding with no giant min-height restrictions */}
      <section className="relative py-16 lg:py-24 overflow-hidden bg-[#020617]">
        
        {/* 
          Restricted Video Height: 
          Uses max-h-[500px] (or similar) so the video doesn't stretch to fill the entire tall screen height.
          We also add a bottom gradient fadeout so the video transitions smoothly into the dark background.
        */}
        <div className="absolute inset-x-0 top-0 h-[450px] md:h-[550px] overflow-hidden pointer-events-none z-0">
          <video
            autoPlay
            loop
            muted
          ...
          {/* Subtle gradient overlay to fade the limited-height video out */}
