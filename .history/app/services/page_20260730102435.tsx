    ...
    <div className="min-h-screen bg-[#0d0f10] text-gray-300 flex flex-col items-center justify-center p-6 md:p-12">
      ...
      <div className="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-12 rounded-2xl overflow-hidden border border-zinc-800 bg-[#121416] shadow-2xl">
        ...
        <div className="lg:col-span-7 grid grid-cols-1 md:grid-cols-2">
          ...
          <div className="p-8 md:p-10 border-b border-zinc-800 md:border-r flex flex-col justify-between min-h-[240px] hover:bg-[#15181a] transition-colors group">
          ...
          <div className="p-8 md:p-10 border-b border-zinc-800 flex flex-col justify-between min-h-[240px] hover:bg-[#15181a] transition-colors group">
          ...
          <div className="p-8 md:p-10 border-b md:border-b-0 border-zinc-800 md:border-r flex flex-col justify-between min-h-[240px] hover:bg-[#15181a] transition-colors group">
          ...
          <div className="p-8 md:p-10 flex flex-col justify-between min-h-[240px] hover:bg-[#15181a] transition-colors group">
