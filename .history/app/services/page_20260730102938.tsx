  ...
  return (
    <div className="min-h-screen bg-[#0d0f10] text-gray-300 flex flex-col items-center justify-center p-6 md:p-12">
      ...
      <div className="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-12 gap-10">
        ...
        <div className="lg:col-span-5 p-8 md:p-12 flex flex-col justify-between items-start gap-8 rounded-2xl border border-zinc-800 bg-gradient-to-b from-[#141719] to-[#121416] shadow-2xl">
