...
const ServicePage = () => {
  return (
    <div className="min-h-screen bg-[#0d0f10] text-gray-300 flex flex-col items-center justify-center p-6 md:p-12">
      ...
      {/* Main Grid Container (Removed gap-20 and fixed gray-300 background to match dark tone) */}
      <div className="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-12 rounded-2xl overflow-hidden border border-zinc-800 bg-[#121416] shadow-2xl">
        
        {/* Left Section: Hero Text & Value Proposition */}
        <div className="lg:col-span-5 p-8 md:p-12 flex flex-col justify-between items-start gap-8 border-b lg:border-b-0 lg:border-r border-zinc-800 bg-gradient-to-b from-[#141719] to-[#121416]">
        ...
        {/* Right Section: Connected Features Grid (No gap layout, cards share borders natively) */}
        <div className="lg:col-span-7 grid grid-cols-1 md:grid-cols-2 bg-[#121416]">
          
          {/* Card 1: Project Management */}
          <div className="p-10 border-b border-zinc-800 md:border-r flex flex-col justify-between min-h-[260px] hover:bg-[#15181a] transition-colors group">
          ...
          <div className="p-10 border-b border-zinc-800 flex flex-col justify-between min-h-[260px] hover:bg-[#15181a] transition-colors group">
          ...
          <div className="p-10 border-b md:border-b-0 border-zinc-800 md:border-r flex flex-col justify-between min-h-[260px] hover:bg-[#15181a] transition-colors group">
          ...
          <div className="p-10 flex flex-col justify-between min-h-[260px] hover:bg-[#15181a] transition-colors group">
